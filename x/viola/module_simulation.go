...
import (
	...
	"viola/testutil/sample"
	violasimulation "viola/x/viola/simulation"
	"viola/x/viola/types"
)
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	violaGenesis := types.GenesisState{
	...
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&violaGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreatePost,
		violasimulation.SimulateMsgCreatePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgUpdatePost,
		violasimulation.SimulateMsgUpdatePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeletePost,
		violasimulation.SimulateMsgDeletePost(am.accountKeeper, am.bankKeeper, am.keeper),
	))
